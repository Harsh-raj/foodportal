...
<%@page import="com.prj.web.model.Stocks"%>
...
<%ArrayList<Stocks> s1 = (ArrayList<Stocks>)request.getAttribute("Stocks");%>
  ...
  <article>
    ...
    <table id="myTable" class="head">
        <tr>
            ...
            <td onclick="sortTable(2)">Quantity</td>
        </tr>
    <%
    Iterator<Stocks> iter = s1.iterator();
    while(iter.hasNext())
    {
        Stocks yp = iter.next();
        %>
