...
<section>
  ...
  <article>
    <div class="login">
  <h1>Welcome to Bhoj<sup>&reg</sup> Fast-Food.</h1>
  <form method="get" action="GetLogin">
    <p><input type="text" name="lname" placeholder="Username"></p>
    <p><input type="password" name="lpass" placeholder="Password"></p>
    <p class="remember_me">
      <label>
        <input type="checkbox" name="adminlog" id="remember_me">
        Are you an Admin...
      </label>
    </p>
